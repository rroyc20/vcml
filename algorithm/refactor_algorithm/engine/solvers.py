...
from refactor_algorithm.core.master.arc_based_check import (
    ...
    solve_arc_based_pcarp_flow,
    solve_arc_based_pcarp_flow_optimal,
...
def solve_arc(instance: Dict[str, Any], time_limit: float, connectivity_model: str = "flow") -> Dict[str, Any]:
    ...
    if connectivity_model == "flow":
        return solve_arc_based_pcarp_flow_optimal(instance)
