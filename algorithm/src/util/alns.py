...
from src.util.initial_heuristic import build_route_path_for_edges, canon_edge
...
def _objective_from_assignment(
    ...
    from src.master.compare_arc_vs_bnp import discount_objective_cost_per_edge, path_arcs_travel_total
