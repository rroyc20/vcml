...
from src.master.compare_arc_vs_bnp import (
    SimpleSPMaster,
    _canon_edge,
...
from src.util.initial_heuristic import add_cover_artificials, canon_edge
...
class AggregatedMaster:
    ...
    def _add_initial_columns(self) -> None:
        ...
        if not self.agg_route_columns:
            from src.master.compare_arc_vs_bnp import _single_service_route
